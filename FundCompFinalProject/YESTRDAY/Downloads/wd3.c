...
int main()
{
    ...
    for(i = 0; i < 100; i++)    printf("%s", words[i]);
    ...
    while(1)
    {
        ...
        if(strcmp(input, NULL))         gfx_text(centX, 575, "[ENTER TEXT TO SAVE THE WORLD]");
        else if(!(strcmp(input, NULL)))    gfx_text(centX, 575, input);
        /*----------*/
